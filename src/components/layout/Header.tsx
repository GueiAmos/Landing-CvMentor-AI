            ...
            <div className="flex flex-col py-2 px-4 gap-2">
              {NAV_SECTIONS.map((section) => (
                <a
                  key={section.id}
                  href={`#${section.id}`}
                  className="text-gray-800 hover:text-orange-500 font-semibold px-2 py-3 rounded transition-colors duration-150 text-base border-b border-gray-100 last:border-b-0"
